...
class RoutesController extends Controller
{
    ...
    public function showAdmin(Request $request)
    {
        ...
        $recordsByProgram = (clone $statsQuery)
            ->selectRaw('program, count(*) as count')
            ->groupBy('program')
            ->orderByRaw('count(*) desc')
            ->pluck('count', 'program');
        $recordsByLine = (clone $statsQuery)
        ...
        $modeOfPaymentMunicipalityData = (clone $statsQuery)
            ->selectRaw('modeOfPayment, province, municipality, count(*) as count')
            ->whereNotNull('modeOfPayment')
            ->where('modeOfPayment', '!=', '')
            ->whereNotNull('municipality')
            ->where('municipality', '!=', '')
        ...
        $recordsByMunicipality = (clone $statsQuery)
